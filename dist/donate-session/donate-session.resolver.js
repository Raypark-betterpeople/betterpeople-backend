...
exports.DonateSessionResolver = void 0;
...
let DonateSessionResolver = class DonateSessionResolver {
    constructor(donateSessionService) {
        this.donateSessionService = donateSessionService;
    }
    async createDonate(createDonateInput) {
        try {
            const { ok, error } = await this.donateSessionService.createDonate(createDonateInput);
            if (error) {
                return {
                    ok,
                    error,
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_donate_dto_1.CreateDonateInput]),
    __metadata("design:returntype", Promise)
], DonateSessionResolver.prototype, "createDonate", null);
__decorate([
    (0, graphql_1.Query)(() => all_donate_dto_1.AllDonateOutput),
    __metadata("design:type", Function),
...
], DonateSessionResolver);
exports.DonateSessionResolver = DonateSessionResolver;
//# sourceMappingURL=donate-session.resolver.js.map